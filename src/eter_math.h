...
static inline float ivec2_len(ivec2 v) { return sqrtf((float)v.x * v.x + (float)v.y * v.y); }
static inline int ivec2_len2(ivec2 v) { return v.x*v.x + v.y*v.y; }
...
static inline float ivec3_len(ivec3 v) { return sqrtf((float)v.x * v.x + (float)v.y * v.y + (float)v.z * v.z); }
static inline int ivec3_len2(ivec3 v) { return v.x*v.x + v.y*v.y + v.z*v.z; }
...
static inline float fvec2_len(fvec2 v) { return sqrtf(v.x * v.x + v.y * v.y); }
static inline float fvec2_len2(fvec2 v) { return v.x*v.x + v.y*v.y; }
...
static inline float fvec3_len(fvec3 v) { return sqrtf(v.x * v.x + v.y * v.y + v.z * v.z); }
static inline float fvec3_len2(fvec3 v) { return v.x*v.x + v.y*v.y + v.z*v.z; }
